...
export const CONTACT_LOCATION = "241 Manningham Lane, Bradford, BD8 7ER";

export const CONTACT_MAP_URL =
  "https://maps.google.com/maps?q=53.805529090563745,-1.7646422584869066&z=15&output=embed";
